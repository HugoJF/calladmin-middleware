...
@section('content')
    <h2>Statistics</h2>
    <ul>
        <li><h4 class="mb-2">Active reports: {{ $reports->toArray()['total'] }} <small>({{ \App\Report::whereNotNull('video_url')->whereNull('ignored_at')->whereNull('decision')->count() }} with video)</small></h4></li>

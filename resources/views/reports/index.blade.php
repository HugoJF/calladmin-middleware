...
@section('content')
    <h2>Statistics</h2>
    <ul>
        <li><h4 class="mb-2">Active reports: {{ $reports->toArray()['total'] }} <small>({{ $reports->filter(function ($report) { return !is_null($report->video_url); })->count() }} with video)</small></h4></li>
